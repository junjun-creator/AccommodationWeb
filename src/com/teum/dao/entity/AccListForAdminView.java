...
public AccListForAdminView(int id, String name, String phone, String location, int regStatus,
	...
	super(id, name, phone, location, regStatus, approvalDate, adiminId, companyId, regdate, accTypeId, gtStartDate,
