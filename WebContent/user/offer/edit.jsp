                        ...
                        <div>
                            ...
                            <section>
                                ...
                                <select class="form-option main-city">
                                    ...
                                    <option name="busan">부산</option>
                                    <option name="jeju">제주</option>
                                    <option name="gyeonggi">경기</option>
                                    <option name="incheon">인천</option>
                                    <option name="gangwon">강원</option>
                                    <option name="gyeongsang">경상</option>
                                    <option name="jeonla">전라</option>
                                    <option name="chungcheong">충청</option>
                                </select>
                                <select class="form-option sub-city">
                                    <option name="sub-option" selected>강남/역삼/삼성</option>
                                    <option name="sub-option">신사/청담/압구정</option>
                                    <option name="sub-option">서초/교대/사당</option>
                                    <option name="sub-option">잠실/송파/강동</option>
                                    <option name="sub-option">을지로/명동/중구</option>
                                    <option name="sub-option">서울역/이태원/용산</option>
                                    <option name="sub-option">종로/인사동</option>
                                    <option name="sub-option">동대문구</option>
                                    <option name="sub-option">홍대/합정/마포/서대문</option>
                                    <option name="sub-option">여의도</option>
                                    <option name="sub-option">영등포역</option>
                                    <option name="sub-option">구로/신도림/금천</option>
                                    <option name="sub-option">김포공항/염창/강서</option>
                                    <option name="sub-option">건대입구/성수/왕십리</option>
                                    <option name="sub-option">성북/강북/노원/도봉</option>
                                </select>
                            </section>
                            <section>
                                <i class="fas fa-hotel"></i><span>&nbsp;&nbsp;&nbsp;타입&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                <select class="form-option category">
                                    <option value="" name="">호텔</option>
                                    <option value="" name="">모텔</option>
                                    <option value="" name="">펜션</option>
                                    <option value="" name="">리조트</option>
                                    <option value="" name="">게스트하우스</option>
                                </select>
                            </section>
                            <section>
