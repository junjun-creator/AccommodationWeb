...
<body>
                            ...
                            <table>
                                ...
                                <% for(Member m : list){ %>
                                    <tr>
                                        ...
                                        <td class="col-sm user-type"><%=m.getType() %></td>
    ...
    <script type="text/javascript">
		...
		for(var i=0;i<rank.length;i++){
	    	if(rank[i].innerText == 0)
	    		rank[i].innerHTML = "<i class='fal fa-diamond'></i>";
	    	else if(rank[i].innerText == 1)
	    		rank[i].innerHTML = "<i class='fas fa-diamond'></i>";
	    	else if(rank[i].innerText == 2)
	    		rank[i].innerHTML = "<i class='fal fa-gem'></i>";
	    	else if(rank[i].innerText == 3)
				rank[i].innerHTML = "<i class='fas fa-gem'></i>";
